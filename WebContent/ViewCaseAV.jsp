...
<body>    
    ...
    <%
    	...
    	if(pname!=null)
    	{
    		try
    		{
    			...
    			PreparedStatement pstmt=con.prepareStatement("select * from prescription where pname=?");
    ...
    %>			
    				...
    				<h3>Prescription : <%=rs.getString(3)%></h3>
    				
    				<a href="DeleteCase.jsp?pname=<%=rs.getString(1)%>">Delete</a>
    				<a href="AVViewPrescription.jsp?pname=<%=rs.getString(1)%>">View Prescription</a>
