    ...
    <%
    	...
    	if(pname!=null)
    	{
    		try
    		{
    			...
    			{
    %>			
    				<h3>Patient Name : <%=rs.getString(1)%></h3>
    				<h3>Patient Age : <%=rs.getString(2)%></h3>
    				<h3>Patient Gender : <%=rs.getString(3)%></h3>
    				<h3>Patient Address : <%=rs.getString(4)%></h3>
    				<h3>Mobile Number : <%=rs.getString(5)%></h3>
    				<h3>Symptom 1 : <%=rs.getString(6)%></h3>
    				<h3>Symptom 2 : <%=rs.getString(7)%></h3>
    				<h3>Symptom 3 : <%=rs.getString(8)%></h3>
